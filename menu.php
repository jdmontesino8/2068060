...
<body>
  ...
  <br>
  <div id="div2">
  <?php if($resultado->num_rows>0)  { ?> <img src="zoom.jpg"> <?php } ?>
      <div id="div3" >
      <?php
...
<br><br>
  ...
  <input style="width:40%;" classs="btn btn-primary" type="button" onclick="location.href ='index.php ' " value="Eliminar programa">
<br><br>
  <input style="width:40%;" class="btn btn-primary" type="button" onclick="location.href ='index.php' " value="Crear ficha">
  <input style="width:40%;" classs="btn btn-primary" type="button" onclick="location.href ='index.php ' " value="Consultar ficha">
  <input style="width:40%;" class="btn btn-primary" type="button" onclick="location.href ='index.php' " value="Modificar ficha">
  <input style="width:40%;" classs="btn btn-primary" type="button" onclick="location.href ='index.php ' " value="Eliminar ficha">
  <?php
      }
      else
      {
